...
namespace Creating_Types
{
    class Program
    {
        ...
        {
            //вызов задачи 1):
            double root = FindNthRoot(0.004241979, 9, 0.00000001);
            Console.WriteLine($"Assignment result #1 = {root}");

            //вызов задачи 2):
            int[][] numbers = new int[3][];
            numbers[0] = new int[] { 4, 2, 5, 6, 120 };
            numbers[1] = new int[] { 5, 3, 1, 7, 12, 4, 22, 5 };
            ...
            SortBySumOfTheElements(numbers);
            ...
            SortByMaximumOfTheElements(numbers);
